# pythia_dynamical_edge_projection64 Figure Manifest

## Phase Projection

- Figure: `pythia_dynamical_edge_projection64__phase_projection.png`
- Note: `pythia_dynamical_edge_projection64__phase_projection.md`
- Source data: `pythia_dynamical_edge_projection64__trajectory_summary.csv`
...
- Figure: `pythia_dynamical_edge_projection64__poincare_section.png`
- Note: `pythia_dynamical_edge_projection64__poincare_section.md`
- Source data: `pythia_dynamical_edge_projection64__poincare_points.csv`
...
- Figure: `pythia_dynamical_edge_projection64__return_map_projection.png`
- Note: `pythia_dynamical_edge_projection64__return_map_projection.md`
- Source data: `pythia_dynamical_edge_projection64__return_map_points.csv`
- Axes: z_t / z_{t+1}
...
- Figure: `pythia_dynamical_edge_projection64__return_map_pca_summary.png`
- Note: `pythia_dynamical_edge_projection64__return_map_pca_summary.md`
- Source data: `pythia_dynamical_edge_projection64__pca_summary_return_map_points.csv`
...
- Figure: `pythia_dynamical_edge_projection64__nearby_distance_by_step.png`
- Note: `pythia_dynamical_edge_projection64__nearby_distance_by_step.md`
- Source data: `pythia_dynamical_edge_projection64__trajectory_summary.csv`
...
- Figure: `pythia_dynamical_edge_projection64__lag_distance_by_window.png`
- Note: `pythia_dynamical_edge_projection64__lag_distance_by_window.md`
- Source data: `pythia_dynamical_edge_projection64__state_distance_metrics.csv`
