# pythia_dynamical_edge_residual_alpha01_probe Figure Manifest

## Phase Projection

- Figure: `pythia_dynamical_edge_residual_alpha01_probe__phase_projection.png`
- Note: `pythia_dynamical_edge_residual_alpha01_probe__phase_projection.md`
- Source data: `pythia_dynamical_edge_residual_alpha01_probe__trajectory_summary.csv`
...
- Figure: `pythia_dynamical_edge_residual_alpha01_probe__poincare_section.png`
- Note: `pythia_dynamical_edge_residual_alpha01_probe__poincare_section.md`
- Source data: `pythia_dynamical_edge_residual_alpha01_probe__poincare_points.csv`
...
- Figure: `pythia_dynamical_edge_residual_alpha01_probe__return_map_projection.png`
- Note: `pythia_dynamical_edge_residual_alpha01_probe__return_map_projection.md`
- Source data: `pythia_dynamical_edge_residual_alpha01_probe__return_map_points.csv`
- Axes: z_t / z_{t+1}
...
- Figure: `pythia_dynamical_edge_residual_alpha01_probe__return_map_pca_summary.png`
- Note: `pythia_dynamical_edge_residual_alpha01_probe__return_map_pca_summary.md`
- Source data: `pythia_dynamical_edge_residual_alpha01_probe__pca_summary_return_map_points.csv`
...
- Figure: `pythia_dynamical_edge_residual_alpha01_probe__nearby_distance_by_step.png`
- Note: `pythia_dynamical_edge_residual_alpha01_probe__nearby_distance_by_step.md`
- Source data: `pythia_dynamical_edge_residual_alpha01_probe__trajectory_summary.csv`
...
- Figure: `pythia_dynamical_edge_residual_alpha01_probe__lag_distance_by_window.png`
- Note: `pythia_dynamical_edge_residual_alpha01_probe__lag_distance_by_window.md`
- Source data: `pythia_dynamical_edge_residual_alpha01_probe__state_distance_metrics.csv`
