# pythia_embedding_expectation_temp20 Figure Manifest

## Phase Projection

- Figure: `pythia_embedding_expectation_temp20__phase_projection.png`
- Note: `pythia_embedding_expectation_temp20__phase_projection.md`
- Source data: `pythia_embedding_expectation_temp20__trajectory_summary.csv`
...
- Figure: `pythia_embedding_expectation_temp20__poincare_section.png`
- Note: `pythia_embedding_expectation_temp20__poincare_section.md`
- Source data: `pythia_embedding_expectation_temp20__poincare_points.csv`
...
- Figure: `pythia_embedding_expectation_temp20__return_map_projection.png`
- Note: `pythia_embedding_expectation_temp20__return_map_projection.md`
- Source data: `pythia_embedding_expectation_temp20__return_map_points.csv`
- Axes: z_t / z_{t+1}
...
- Figure: `pythia_embedding_expectation_temp20__return_map_pca_summary.png`
- Note: `pythia_embedding_expectation_temp20__return_map_pca_summary.md`
- Source data: `pythia_embedding_expectation_temp20__pca_summary_return_map_points.csv`
...
- Figure: `pythia_embedding_expectation_temp20__nearby_distance_by_step.png`
- Note: `pythia_embedding_expectation_temp20__nearby_distance_by_step.md`
- Source data: `pythia_embedding_expectation_temp20__trajectory_summary.csv`
...
- Figure: `pythia_embedding_expectation_temp20__lag_distance_by_window.png`
- Note: `pythia_embedding_expectation_temp20__lag_distance_by_window.md`
- Source data: `pythia_embedding_expectation_temp20__state_distance_metrics.csv`
