# qwen_dynamical_edge_burn256 Figure Manifest

## Phase Projection

- Figure: `qwen_dynamical_edge_burn256__phase_projection.png`
- Note: `qwen_dynamical_edge_burn256__phase_projection.md`
...
- Figure: `qwen_dynamical_edge_burn256__poincare_section.png`
- Note: `qwen_dynamical_edge_burn256__poincare_section.md`
- Source data: `qwen_dynamical_edge_burn256__poincare_points.csv`
...
- Figure: `qwen_dynamical_edge_burn256__return_map_projection.png`
- Note: `qwen_dynamical_edge_burn256__return_map_projection.md`
- Source data: `qwen_dynamical_edge_burn256__return_map_points.csv`
- Axes: z_t / z_{t+1}
...
- Figure: `qwen_dynamical_edge_burn256__return_map_pca_summary.png`
- Note: `qwen_dynamical_edge_burn256__return_map_pca_summary.md`
- Source data: `qwen_dynamical_edge_burn256__pca_summary_return_map_points.csv`
...
- Note: `qwen_dynamical_edge_burn256__nearby_distance_by_step.md`
- Source data: `qwen_dynamical_edge_burn256__trajectory_summary.csv`
...
- Figure: `qwen_dynamical_edge_burn256__lag_distance_by_window.png`
- Note: `qwen_dynamical_edge_burn256__lag_distance_by_window.md`
- Source data: `qwen_dynamical_edge_burn256__state_distance_metrics.csv`
